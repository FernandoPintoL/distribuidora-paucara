...
export class LogisticaService implements BaseService<Entrega, AsignarEntregaData> {
    ...
    async asignarEntrega(entregaId: Id, data: AsignarEntregaData): Promise<{
        ...
        try {
            const response = await fetch(`/api/encargado/asignar-entrega/${entregaId}`, {
                method: 'POST',
                headers: {
     ...
     */
    async aprobarProforma(proformaId: Id, comentario: string = ''): Promise<{
        success: boolean;
        message: string;
    }> {
        try {
            const response = await fetch(`/api/encargado/aprobar-proforma/${proformaId}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async rechazarProforma(proformaId: Id, motivo: string): Promise<{
        ...
        try {
            ...
            const response = await fetch(`/api/encargado/rechazar-proforma/${proformaId}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
