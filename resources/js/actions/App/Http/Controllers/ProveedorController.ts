...
* @see app/Http/Controllers/ProveedorController.php:165
...
* @see app/Http/Controllers/ProveedorController.php:16
* @route '/proveedores'
*/
...
* @see app/Http/Controllers/ProveedorController.php:100
...
* @see app/Http/Controllers/ProveedorController.php:107
* @route '/proveedores'
*/
...
* @see app/Http/Controllers/ProveedorController.php:189
...
* @see app/Http/Controllers/ProveedorController.php:196
* @route '/proveedores/{proveedore}'
*/
...
* @see app/Http/Controllers/ProveedorController.php:239
* @route '/proveedores/{proveedore}'
*/
