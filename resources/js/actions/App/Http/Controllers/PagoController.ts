...
/**
* @see \App\Http\Controllers\PagoController::checkCajaAbierta
 * @see app/Http/Controllers/PagoController.php:106
 * @route '/compras/pagos/check-caja-abierta'
 */
...
checkCajaAbierta.definition = {
    methods: ["get","head"],
    url: '/compras/pagos/check-caja-abierta',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @see app/Http/Controllers/PagoController.php:178
 * @route '/compras/pagos'
 */
 ...
 * @see app/Http/Controllers/PagoController.php:258
 ...
 * @see app/Http/Controllers/PagoController.php:267
 * @route '/compras/pagos/{pago}'
 */
 ...
 * @see app/Http/Controllers/PagoController.php:284
...
const PagoController = { index, checkCajaAbierta, create, store, show, destroy, exportMethod, export: exportMethod }
