 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:761
 * @route '/api/proformas'
 */
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:1182
...
/**
* @see \App\Http\Controllers\Api\ApiProformaController::searchClientes
 * @see app/Http/Controllers/Api/ApiProformaController.php:4975
 * @route '/api/proformas/search/clientes'
 */
export const searchClientes = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: searchClientes.url(options),
    method: 'get',
})

searchClientes.definition = {
    methods: ["get","head"],
    url: '/api/proformas/search/clientes',
} satisfies RouteDefinition<["get","head"]>
...
searchClientes.url = (options?: RouteQueryOptions) => {
    return searchClientes.definition.url + queryParams(options)
}
 ...
 */
    const searchClientesForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: searchClientes.url(options),
        method: 'get',
    })
...
/**
* @see \App\Http\Controllers\Api\ApiProformaController::searchUsuarios
 * @see app/Http/Controllers/Api/ApiProformaController.php:5020
 * @route '/api/proformas/search/usuarios'
 */
export const searchUsuarios = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: searchUsuarios.url(options),
    method: 'get',
})

searchUsuarios.definition = {
    methods: ["get","head"],
    url: '/api/proformas/search/usuarios',
} satisfies RouteDefinition<["get","head"]>
...
searchUsuarios.url = (options?: RouteQueryOptions) => {
    return searchUsuarios.definition.url + queryParams(options)
}
 ...
 */
    const searchUsuariosForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: searchUsuarios.url(options),
        method: 'get',
    })
...
/**
* @see \App\Http\Controllers\Api\ApiProformaController::prepararImpresion
 * @see app/Http/Controllers/Api/ApiProformaController.php:5066
 * @route '/api/proformas/preparar-impresion'
 */
...
prepararImpresion.definition = {
    methods: ["post"],
    url: '/api/proformas/preparar-impresion',
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:5276
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:5159
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:27
 * @route '/api/proformas'
 */
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:405
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:449
 * @route '/api/proformas/{proforma}'
 */
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:1416
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:1533
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:2635
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:2378
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:1693
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:1588
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:4142
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:1358
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:1789
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:1816
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:1738
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:1377
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:4427
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:1861
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:2116
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:2243
 ...
 * @see app/Http/Controllers/Api/ApiProformaController.php:3243
