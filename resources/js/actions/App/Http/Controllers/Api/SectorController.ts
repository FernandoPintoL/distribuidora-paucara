 ...
 * @see app/Http/Controllers/Api/SectorController.php:329
...
/**
* @see \App\Http\Controllers\Api\SectorController::obtenerSectoresPorAlmacen
 * @see app/Http/Controllers/Api/SectorController.php:374
 * @route '/api/almacenes/{almacenId}/sectores'
 */
export const obtenerSectoresPorAlmacen = (args: { almacenId: string | number } | [almacenId: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: obtenerSectoresPorAlmacen.url(args, options),
    method: 'get',
})

obtenerSectoresPorAlmacen.definition = {
    methods: ["get","head"],
 ...
 * @route '/api/almacenes/{almacenId}/sectores'
 */
obtenerSectoresPorAlmacen.url = (args: { almacenId: string | number } | [almacenId: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { almacenId: args }
    }
    ...
    return obtenerSectoresPorAlmacen.definition.url
            .replace('{almacenId}', parsedArgs.almacenId.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/api/almacenes/{almacenId}/sectores'
 */
obtenerSectoresPorAlmacen.get = (args: { almacenId: string | number } | [almacenId: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: obtenerSectoresPorAlmacen.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/api/almacenes/{almacenId}/sectores'
 */
obtenerSectoresPorAlmacen.head = (args: { almacenId: string | number } | [almacenId: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: obtenerSectoresPorAlmacen.url(args, options),
    method: 'head',
})
 ...
 * @route '/api/almacenes/{almacenId}/sectores'
 */
    const obtenerSectoresPorAlmacenForm = (args: { almacenId: string | number } | [almacenId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: obtenerSectoresPorAlmacen.url(args, options),
        method: 'get',
    })
 ...
 * @route '/api/almacenes/{almacenId}/sectores'
 */
        obtenerSectoresPorAlmacenForm.get = (args: { almacenId: string | number } | [almacenId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: obtenerSectoresPorAlmacen.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/api/almacenes/{almacenId}/sectores'
 */
        obtenerSectoresPorAlmacenForm.head = (args: { almacenId: string | number } | [almacenId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: obtenerSectoresPorAlmacen.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    obtenerSectoresPorAlmacen.form = obtenerSectoresPorAlmacenForm
const SectorController = { index, store, show, update, destroy, obtenerGenerico, obtenerSectoresPorAlmacen }
