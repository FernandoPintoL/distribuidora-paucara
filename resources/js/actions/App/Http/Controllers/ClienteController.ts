 ...
 * @see app/Http/Controllers/ClienteController.php:189
 * @route '/api/clientes'
 */
 ...
 * @see app/Http/Controllers/ClienteController.php:227
 * @route '/api/clientes'
 */
 ...
 * @see app/Http/Controllers/ClienteController.php:287
 * @route '/api/clientes/{cliente}'
 */
 ...
 * @see app/Http/Controllers/ClienteController.php:319
 * @route '/api/clientes/{cliente}'
 */
 ...
 * @see app/Http/Controllers/ClienteController.php:376
 ...
 * @see app/Http/Controllers/ClienteController.php:15
 * @route '/clientes'
 */
 ...
 * @see app/Http/Controllers/ClienteController.php:67
 ...
 * @see app/Http/Controllers/ClienteController.php:74
 * @route '/clientes'
 */
 ...
 * @see app/Http/Controllers/ClienteController.php:124
 ...
 * @see app/Http/Controllers/ClienteController.php:131
 * @route '/clientes/{cliente}'
 */
 ...
 * @see app/Http/Controllers/ClienteController.php:168
 * @route '/clientes/{cliente}'
 */
...
const ClienteController = { indexApi, storeApi, buscarApi, showApi, updateApi, destroyApi, saldoCuentasPorCobrar, historialVentas, index, create, store, show, edit, update, destroy }
