...
export default function StockPage({
    ...
    const [adjustData, setAdjustData] = useState({
        tipo_ajuste: 'disponible' as 'disponible' | 'prestamo_cliente' | 'prestamo_proveedor' | 'vendida' | 'total',
    ...
    const handleOpenEditModal = async (item: StockItem) => {
        ...
        setEditData({
            ...
            cantidad_en_prestamo_cliente: item.cantidad_en_prestamo_cliente,
            cantidad_en_prestamo_proveedor: item.cantidad_en_prestamo_proveedor,
