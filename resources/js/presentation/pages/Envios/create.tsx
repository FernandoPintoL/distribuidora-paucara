...
import { useEnviosCreate } from '@/application/hooks/use-envios-create';
import { getMinDateTimeLocal } from '@/lib/envios.utils';
...
export default function Create({ ventas, vehiculos, choferes, ventaPreseleccionada }: Props) {
    ...
    const {
        ...
        handleSubmit,
        handleVolver,
    } = useEnviosCreate(ventas, vehiculos, choferes, ventaPreseleccionada);
