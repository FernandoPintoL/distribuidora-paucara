            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-md border border-gray-300 px-3 py-2 focus:border-purple-500 focus:outline-none"
                />
                <button
            ...
            {filteredGroups.length === 0 ? (
              ...
              <div className="space-y-6">
                {filteredGroups.map(group => (
                  <div key={group.module} className="border-l-4 border-purple-500 pl-4">
