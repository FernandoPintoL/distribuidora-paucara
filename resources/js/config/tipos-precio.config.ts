...
export const tiposPrecioConfig: ModuleConfig<TipoPrecio, TipoPrecioFormData> = {
  ...
  tableColumns: [
    { key: 'id', label: 'ID', type: 'number' },
    {
      ...
      label: 'Nombre',
      type: 'text',
      render: (value: string, entity: TipoPrecio) => React.createElement('div', {
        className: 'flex items-center gap-2'
      }, [
        entity.configuracion?.icono && React.createElement('span', {
          key: 'icon',
          className: 'text-lg'
    ...
    },
    {
      ...
      type: 'number',
      render: (value: number) => React.createElement('span', {
        className: 'inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-800 border border-gray-200'
      }, `${value} productos`)
    },
