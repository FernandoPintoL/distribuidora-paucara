...
<div class="documento-numero">#{{ $compra->numero }}</div>
...
{{-- ==================== MONTO DESTACADO ==================== --}}
<div style="text-align: center; margin: 10px 0; padding: 10px 0; border: 2px solid #27ae60;">
...
{{-- ==================== ALMACÉN ==================== --}}
@if($compra->almacen)
<div style="font-size: 8px; margin-top: 8px; padding: 8px 0; border-top: 1px solid #ddd;">
...
<div class="observaciones" style="font-size: 7px;">
