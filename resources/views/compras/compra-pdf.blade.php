...
<head>
    <meta charset="UTF-8">
    <title>Compra de Prestables {{ $documento->numero_compra }}</title>
    <style>
        @page {
            size: A4;
            margin: 20mm;
...
<body>
    ...
    <div class="info-section">
        <div class="info-block">
            ...
            <p><span class="label">Número:</span> {{ $documento->numero_compra }}</p>
            <p><span class="label">Fecha:</span> {{ $documento->fecha_compra->format('d/m/Y H:i') }}</p>
        ...
        <div class="info-block">
            ...
            @if($documento->proveedor)
                <p><span class="label">Proveedor:</span> {{ $documento->proveedor->nombre }}</p>
            @else
                <p><span class="label">Proveedor:</span> (Sin proveedor)</p>
            @endif
    ...
    <div class="footer">
        ...
        <p>{{ config('app.name') }} - Sistema de Gestión de Compras Prestables</p>
    </div>
</body>
</html>
