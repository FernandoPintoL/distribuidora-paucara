        ...
        return [
            ...
            'productos'       => [
                ...
                'submenu' => [
                    ...
                    ['titulo' => 'Combos', 'ruta' => '/combos', 'icono' => 'BoxesIcon', 'orden' => 5, 'permisos' => ['productos.manage']],
                    ['titulo' => 'Categorías', 'ruta' => '/categorias', 'icono' => 'FolderTree', 'orden' => 6, 'permisos' => ['categorias.manage']],
                    ['titulo' => 'Marcas', 'ruta' => '/marcas', 'icono' => 'Tags', 'orden' => 7, 'permisos' => ['marcas.manage']],
                    ['titulo' => 'Unidades', 'ruta' => '/unidades', 'icono' => 'Ruler', 'orden' => 8, 'permisos' => ['unidades.manage']],
                    ['titulo' => 'Tipo Precios', 'ruta' => '/tipos-precio', 'icono' => 'DollarSign', 'orden' => 9, 'permisos' => ['tipos-precio.manage']],
                    ['titulo' => 'Rangos de Precios', 'ruta' => '/precio-rango', 'icono' => 'TrendingDown', 'orden' => 10, 'permisos' => ['productos.manage']],
                ],
            ],
