        ...
        return [
            ...
            'inventario'      => [
                ...
                'submenu' => [
                    ...
                    ['titulo' => 'Movimientos', 'ruta' => '/inventario/movimientos', 'icono' => 'ArrowUpDown', 'orden' => 3, 'permisos' => ['inventario.movimientos']],
                    ['titulo' => 'Transferencias', 'ruta' => '/inventario/transferencias', 'icono' => 'ArrowRightLeft', 'orden' => 4, 'permisos' => ['inventario.transferencias.index']],
                    ['titulo' => 'Mermas', 'ruta' => '/inventario/mermas', 'icono' => 'Package2', 'orden' => 5, 'permisos' => ['inventario.mermas.index']],
                    ['titulo' => 'Ajustes', 'ruta' => '/inventario/ajuste', 'icono' => 'Settings', 'orden' => 6, 'permisos' => ['inventario.ajuste.form']],
                    ['titulo' => 'Carga Masiva', 'ruta' => '/inventario/ajuste-masivo', 'icono' => 'FileUp', 'orden' => 7, 'permisos' => ['inventario.ajuste.form']],
                    ['titulo' => 'Tipos de Ajuste', 'ruta' => '/inventario/tipos-ajuste-inventario', 'icono' => 'Sliders', 'orden' => 8, 'permisos' => ['inventario.tipos-ajuste.index']],
            ...
            'reportes'        => [
                ...
                'submenu' => [
                    ...
                    ['titulo' => 'Ranking de Clientes', 'ruta' => '/reportes/ventas/ranking-clientes', 'icono' => 'Trophy', 'orden' => 4, 'permisos' => ['reportes.ventas.ranking-clientes']],
                    ['titulo' => 'Entregas por Chofer', 'ruta' => '/reportes/ventas/entregas-por-chofer', 'icono' => 'Truck', 'orden' => 5, 'permisos' => ['reportes.ventas.entregas-por-chofer']],
                    ['titulo' => 'Entregas por Cliente', 'ruta' => '/reportes/ventas/entregas-por-cliente', 'icono' => 'Package', 'orden' => 6, 'permisos' => ['reportes.ventas.entregas-por-cliente']],
                    ['titulo' => 'Stock Actual', 'ruta' => '/reportes/inventario/stock-actual', 'icono' => 'Package', 'orden' => 7, 'permisos' => ['reportes.inventario.stock-actual']],
                    ['titulo' => 'Movimientos', 'ruta' => '/reportes/inventario/movimientos', 'icono' => 'ArrowUpDown', 'orden' => 8, 'permisos' => ['reportes.inventario.movimientos']],
                    ['titulo' => 'Rotación', 'ruta' => '/reportes/inventario/rotacion', 'icono' => 'RotateCcw', 'orden' => 9, 'permisos' => ['reportes.inventario.rotacion']],
