...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('precios_producto', function (Blueprint $table) {
            $table->unsignedBigInteger('tipo_precio_id')->nullable()->after('tipo_cliente');
        });
        ...
        Schema::table('precios_producto', function (Blueprint $table) {
            // Eliminar índices que puedan existir en la columna antigua
            try {
    ...
    public function down(): void
    {
        Schema::table('precios_producto', function (Blueprint $table) {
            ...
            $table->dropIndex(['tipo_precio_id']);

            // Agregar columna string de vuelta
            $table->string('tipo_precio', 20)->nullable()->after('tipo_cliente');
        });
        ...
        DB::statement("
            UPDATE precios_producto
            SET tipo_precio = (
                SELECT LOWER(codigo) FROM tipos_precio WHERE id = precios_producto.tipo_precio_id
            )
