...
return new class extends Migration
{
    ...
    {
        // Agregar CANCELADO al CHECK constraint de estado en prestamo_cliente
        // Primero, eliminar la restricción actual
        DB::statement("
            ALTER TABLE prestamo_cliente
            DROP CONSTRAINT prestamo_cliente_estado_check
        ");

        // Luego, agregar la nueva restricción con CANCELADO incluido
        DB::statement("
            ALTER TABLE prestamo_cliente
            ADD CONSTRAINT prestamo_cliente_estado_check
