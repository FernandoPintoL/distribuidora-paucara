...
class ClientePolicy
{
    ...
    {
        // Gestores de clientes, admins, y managers pueden ver todos
        if ($user->hasAnyRole(['Gestor de Clientes', 'Admin', 'Manager', 'Super Admin', 'Vendedor'])) {
            return true;
        }
        return false;
    }
    ...
    {
        // Solo gestores de clientes, empleados y admins pueden crear clientes
        return $user->hasAnyRole(['Gestor de Clientes', 'Vendedor', 'Chofer', 'Cajero', 'Admin', 'Manager', 'Super Admin']);
    }
    ...
    public function update(User $user, Cliente $cliente): bool
    {
        ...
        if ($user->hasAnyRole(['Gestor de Clientes', 'Admin', 'Manager', 'Super Admin'])) {
            return true;
        }

        // Vendedores y cajeros pueden editar clientes que crearon
